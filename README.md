...
- `make add-token asset_id=0xBdA556fC49Def42DfA6406Fd5E0Ba86efdc9bC53` -- Create `info.json` file as asset template.
- `make add-tokenlist asset_id=0xBdA556fC49Def42DfA6406Fd5E0Ba86efdc9bC53 ` -- Adds a token to tokenlist.json.
